...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://clothingcompanysydney.com/cdn/shop/files/Hf717e6040aeb47b094a994741a1bca2e3_08c43190-904b-4a96-bc21-de223e42a773.jpg?width=536&height=652"
              width="536"
              height="652"
              align="center"
              valign="middle"
      ...
      <h3 class="w3-large w3-center" style="margin-top:15px;">
        <a href="https://github.com/tiqsclass6/gcp-repo-assignments/blob/assignment-05242025/brazil.sh"
