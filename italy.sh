...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://www.hardcoreitalians.com/cdn/shop/files/bikini-model-top2.jpg?v=1724984501&width=540"
              width="540"
              height="540"
              align="center"
              valign="middle"
      ...
      <h3 class="w3-large w3-center" style="margin-top:15px;">
        <a href="https://github.com/tiqsclass6/gcp-repo-assignments/blob/assignment-05312025/italy.sh"
